    ...
    static async verifySignature(req, res, next) {
        try {
            ...
            if (!address || !message || !signature) {
                throw new BadRequestError('Missing required fields: address, message, signature');
            }

            // Verify signature and authenticate
            const result = await WalletAuthService.verifySignatureAndAuth(address, message, signature);

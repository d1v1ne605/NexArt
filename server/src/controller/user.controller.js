...
class UserController {
    getCurrentUser = async (req, res, next) => {
        try {
            ...
            const { is_active, nonce_count, last_login, ...publicUserData } = userData;
    ...
    try {
      if (!req.user) {
        throw new AuthFailureError("Not authenticated");
            ...
            const updateData = {};
            if (req.body.display_name !== undefined && req.body.display_name !== '') updateData.display_name = req.body.display_name;
